...
import { GitBranch, Plus, User, Bot, Trash2, GitMerge, ChevronRight, ChevronDown, PanelLeftClose, PanelLeftOpen } from 'lucide-react';
                         ...
                         <div className="space-y-4 p-2 pb-4">
                             {messages.map((msg) => (
                                <div key={msg.id} className={`flex gap-3 ${msg.role === 'user' ? 'flex-row-reverse' : ''}`}>
                                    ...
                                    <div className={`text-[11px] p-2 rounded-lg max-w-[90%] leading-relaxed ${
